      ...
      <div className="profile-card">
        ...
        <div className="profile-card__body">
          <div className="profile-card__body-profile">
            ...
            <span>{fullName ? fullName : "No name set."}</span>
            <span
              style={{
                fontSize: "10px",
                fontWeight: "bold",
              ...
              <div className="body-billing-form">
                <form className="billing-form">
                  ...
                  <div className="billing-form-content">
                    <div className="billing-form__labelSection">
                      <label>Email</label>
                      <input disabled placeholder={userData?.email} />
                    </div>
                  </div>
                  <div className="billing-form-content">
                    <div className="billing-form__labelSection">
                      <label>Street Address</label>
                      <input placeholder={billingAddress?.line1} />
                    </div>
                  </div>
                  <div className="billing-form-content">
                    <div className="billing-form__labelSection">
                      <label>City</label>
                      <input placeholder={billingAddress?.city} />
                    </div>
                  </div>
                  <div className="billing-form-content">
                    <div className="billing-form__labelSection">
                      <label>State</label>
                      <input placeholder={billingAddress?.state} />
                    </div>
                  </div>
                </form>
              </div>
